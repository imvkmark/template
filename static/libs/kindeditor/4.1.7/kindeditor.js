define("kindeditor/4.1.7/kindeditor", [], function() {
...
_plugin('core', function(K) {
	...
	KindEditor.basePath = ixdcw.domain.cssjs+'js/libs/kindeditor/4.1.7/';
	KindEditor.iConfig = {};
	...
	KindEditor.iConfig.dft = [
		...
		'link', 'unlink','emoticons','table','image', 'multiimage','flash','|', 'source', 'about'
	];
